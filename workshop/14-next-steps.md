...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-governance-and-policies.md) — apply least-privilege permissions, branch protection rules, and org-level policies to scale agentic workflows safely (enterprise teams).
