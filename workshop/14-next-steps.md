...
- ➡️ [Trigger Workflows Across Repositories](27-cross-repository-workflows.md) — read data from or dispatch to other repositories in your organisation (enterprise teams).
