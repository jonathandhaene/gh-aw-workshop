...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-enterprise-governance.md) — configure org-level approval gates, CODEOWNERS rules, and Actions permissions policies to keep AI write access under control (enterprise teams).
