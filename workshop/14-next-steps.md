...
- ➡️ [Read Data Across Multiple Repositories](27-cross-repository-workflows.md) — build a cross-repository reporter that reads from several repos and posts a consolidated summary (enterprise teams).
