...
- ➡️ [Govern Who Can Run Agentic Workflows](27-governance-and-policy.md) — define per-workflow approval policies, restrict external domains, and set up branch protection for workflow files (enterprise teams).
