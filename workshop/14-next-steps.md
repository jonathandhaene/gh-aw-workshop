...
- ➡️ [Enforce Governance and Policy for Agentic Workflows](27-governance-and-policy.md) — add branch protection rules, CODEOWNERS, and org-level Copilot policies so every AI-generated PR is reviewed by a human before merging (enterprise teams).
