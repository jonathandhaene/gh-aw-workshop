...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-governance-and-policies.md) — apply organisation-level model allowlists, environment protection rules, and policy documentation (enterprise teams).
