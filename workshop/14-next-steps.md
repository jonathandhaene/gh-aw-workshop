...
- ➡️ [Govern Your Agentic Workflows: Policy, Approval, and Compliance](27-governance-and-compliance.md) — set Copilot access policies, scope token permissions, require approval gates, and confirm your audit trail meets enterprise compliance requirements.
