...
- ➡️ [Govern Agentic Workflows at Enterprise Scale](27-enterprise-governance.md) — configure CODEOWNERS, branch protection, org-level Actions policies, and a phased rollout plan (enterprise teams).
