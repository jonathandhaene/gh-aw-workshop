...
- ➡️ [Governance and Approval Gates for Agentic Workflows](27-governance-and-approval-gates.md) — add required-reviewer environment gates so a human approves every agentic write before it reaches production (enterprise teams).
