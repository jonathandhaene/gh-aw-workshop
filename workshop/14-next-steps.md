...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-enterprise-governance.md) — configure org-level Actions policies, CODEOWNERS for workflow files, and cross-repo visibility (enterprise teams).
