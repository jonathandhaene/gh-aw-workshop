...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-governance-and-policy.md) — audit permissions, apply required approvals, and set org-level Actions policies to keep AI automation safe at scale (enterprise teams).
