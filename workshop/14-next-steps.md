...
- ➡️ [Govern Who Can Run Your Agentic Workflows](27-governance-and-approval-gates.md) — add environment approval gates, concurrency groups, and minimum-permission scopes to keep automation safe in production (enterprise teams).
