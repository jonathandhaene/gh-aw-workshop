...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-org-governance.md) — centralise approved workflow templates, enforce org-wide permission policies, and build an audit trail for compliance (enterprise teams).
