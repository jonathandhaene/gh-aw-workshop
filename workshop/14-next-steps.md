...
- ➡️ [Cross-Repository Agentic Workflows](27-cross-repository-workflows.md) — extend a single workflow to read from multiple repositories and produce org-wide summaries (enterprise teams).
