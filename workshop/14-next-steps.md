...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-enterprise-governance.md) — configure org-level Copilot policies, environment protection rules, and Actions allow-lists to run AI workflows safely at scale (enterprise teams).
