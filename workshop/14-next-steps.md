...
- ➡️ [Review Before You Write: Staged Mode](27-staged-mode.md) — add a human approval checkpoint before any agent write executes (enterprise teams and high-trust production workflows).
