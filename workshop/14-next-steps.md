...
- ➡️ [Run Agentic Workflows Across Multiple Repositories](27-cross-repository-workflows.md) — extend a workflow to query several repos in one run using the GitHub MCP server (enterprise teams managing multi-repo portfolios).
