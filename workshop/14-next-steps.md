...
- ➡️ [Govern Who Can Run Your Agentic Workflows](27-governance-and-approval-gates.md) — add environment protection rules and approval gates so agent runs require explicit sign-off before executing (enterprise teams).
