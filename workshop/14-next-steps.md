...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-enterprise-governance.md) — configure org-level Copilot-in-Actions policies, protected environments, and a pre-production governance checklist (enterprise teams).
