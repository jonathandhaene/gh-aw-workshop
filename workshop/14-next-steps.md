...
- ➡️ [Govern Your Agentic Workflows with Organisation Policies](27-workflow-governance.md) — apply CODEOWNERS review gates, branch protection rules, and org-level permission caps to keep production workflows safe (enterprise teams).
