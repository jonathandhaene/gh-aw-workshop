...
- ➡️ [Enforce Organisation-Wide Governance for Agentic Workflows](27-enterprise-governance.md) — apply org-wide model policies, environment protection rules, Actions permissions, and a repeatable governance checklist (enterprise teams).
