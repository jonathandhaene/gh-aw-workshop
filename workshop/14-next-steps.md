...
- ➡️ [Govern Your Agentic Workflows with Required Approvals](27-workflow-governance.md) — add human approval gates to production agentic runs using GitHub Environments (enterprise teams).
