...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-enterprise-governance.md) — use `gh aw env` to set org-wide defaults, lock settings, and maintain consistent guardrails across all repositories (enterprise teams).
