...
- ➡️ [Govern Agentic Workflows Across Your Organisation](27-governance-and-policy.md) — set org-wide model policies, protect workflow files with CODEOWNERS, and draft a governance baseline (enterprise teams).
