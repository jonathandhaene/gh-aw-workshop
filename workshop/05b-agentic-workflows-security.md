...
Letting an AI agent act on your repository on a schedule only works if it can't do damage. [Agentic workflows](https://github.github.com/gh-aw/introduction/overview/) enforce two trust boundaries so you can run agents in automation with confidence.
