...
> _Optional: use this quick reference if you want help choosing a schedule expression for [Schedule Your Workflow to Run Automatically](13-schedule-your-workflow.md), then return to the main adventure._

## 📋 Before You Start

- You have completed [Schedule Your Workflow to Run Automatically](13-schedule-your-workflow.md) or are working through it now.
...
Return to the main adventure: [Schedule Your Workflow to Run Automatically](13-schedule-your-workflow.md).
