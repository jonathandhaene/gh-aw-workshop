...
| 27 | [Govern Agentic Workflows at Scale](27-enterprise-governance.md) |
...
- [Govern Agentic Workflows at Scale](27-enterprise-governance.md) — organisation-level Actions policies, branch protection rules with compile-validation checks, shared organisation secrets, workflow inventory, and GHEC Copilot policy confirmation; continues from [Step 26](26-manage-costs-and-budgets.md) and serves enterprise and team learners.
