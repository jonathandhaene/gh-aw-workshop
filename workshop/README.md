...
- [Govern Agentic Workflows Across Your Organisation](27-governance-and-policy.md) — four-layer governance model (frontmatter permissions, repository settings, org policy, required approval environments), least-privilege permission audit, branch protection with CODEOWNERS, and GHES/GHEC org-level Actions policy; branches from [What's Next?](14-next-steps.md) (enterprise teams).
