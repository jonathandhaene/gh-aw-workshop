...
A supply chain attack through [MCP](https://github.github.com/gh-aw/reference/mcp-gateway/) starts when you trust a tool server, package, or image that can change outside your repository, and that server returns data your agent treats as real.
