...
<picture>
   <source media="(prefers-color-scheme: dark)" srcset="images/00-agentic-workflow-loop-dark.svg">
   <source media="(prefers-color-scheme: light)" srcset="images/00-agentic-workflow-loop-light.svg">
   <img alt="Agentic workflow loop: a schedule trigger fires every day, the AI agent reads your repository activity, decides what matters, then publishes a daily status report as a GitHub Issue." src="images/00-agentic-workflow-loop-light.svg">
</picture>
