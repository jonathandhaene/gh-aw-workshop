...
Along the way, you'll learn how to [compile the workflow](https://github.github.com/gh-aw/reference/compilation-process/), trigger test runs, and iterate on the prompt until the output matches your intent.
