...
>
> - Want a deeper look at how the [agentic loop](https://github.github.com/gh-aw/introduction/how-they-work/) changes, what the `tools:` block does, and how to read tool calls in the Actions log? Work through [Side Quest: How MCP Tool Servers Work](side-quest-17-01-mcp-concepts.md).  
