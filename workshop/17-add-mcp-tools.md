...
> [!NOTE]
> The `github` tool entry tells gh-aw to start the GitHub MCP server in proxy mode. The agent can then call GitHub tools — listing issues, fetching commits, reading file contents — scoped to the [permissions](https://github.github.com/gh-aw/reference/permissions/) you've declared above.
